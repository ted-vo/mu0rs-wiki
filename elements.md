...
| Reduce `Critical` / `Excellent` / `Ignore` / `Double`  Dmg Rate `x%` | <span class="mdi mdi-sword"/> | <span class="mdi mdi-check"/> | <span class="mdi mdi-check"/> | <span class="mdi mdi-check"/> | <span class="mdi mdi-check"/> | <span class="mdi mdi-check"/> | | <span class="mdi mdi-check"/> | <span class="mdi mdi-check"/> | | | |
